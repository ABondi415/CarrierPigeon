...
public class WebAuthenticationDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v8", "WebAuthenticationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userCredential");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v8", "UserCredential"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v8", "WebAuthenticationCredential"));
