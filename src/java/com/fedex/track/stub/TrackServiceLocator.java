...
public class TrackServiceLocator extends org.apache.axis.client.Service implements com.fedex.track.stub.TrackService {
   ...
   private java.lang.String TrackServicePort_address = "https://ws.fedex.com:443/web-services/track";
    //private java.lang.String TrackServicePort_address = "http://localhost:5555";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/track/v8", "TrackService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/track/v8", "TrackServicePort"));
        }
